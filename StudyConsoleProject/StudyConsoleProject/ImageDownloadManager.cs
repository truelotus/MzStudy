...
namespace StudyConsoleProject
{
    ...
    class ImageDownloadManager
    {
        ...
        String[] mSearchWordList;
        public ImageDownloadManager(String[] wordList) 
        {
            this.mSearchWordList = wordList;
        }
        public void StartListSearchDownload() 
        {
            Console.Title = "Download Web Image";

            mWatch = new Stopwatch();
            mWatch.Start();

            String[] searchWordList = mSearchWordList;
                ...
                bool isSuccess = ThreadPool.QueueUserWorkItem(q =>
                {
                    ...
                    for (int i = 0; i < refList.Count; i++)
                    {
                        try
                        {
                            ...
                            else
                            {
                               ...
                               // Console.Write("Save");
                                ...
                                Console.Write(" " + downloadFilePath);
                                Console.WriteLine(" ");
                                Console.ResetColor();
                        ...
                        catch (Exception)
                        {
                            ...
                            Console.Write("DownloadFile Exception");
                            Console.ResetColor();
                        }
                    }
                });
                Console.Write("ThreadPool Queue 저장 성공 여부 : ");
